...
public class Advancements {
    public static Map<String, String> Advancements = new HashMap<String, String>() {{
        ...
        put("husbandry/ride_a_boat_with_a_goat","**[Whatever Floats Your Goat!]**");
        put("end/kill_dragon","**[Free the End]**");
        put("adventure/lightning_rod_with_villager_no_fire","**[Surge Protector]**");
        put("husbandry/tame_an_animal","**[Best Friends Forever]**");
        put("husbandry/make_a_sign_glow","**[Glow and Behold!]**");
        ...
        put("nether/ride_strider","**[This Boat Has Legs]**");
        ...
        put("adventure/walk_on_powder_snow_with_leather_boots","**[Light as a Rabbit]**");
        ...
        put("adventure/spyglass_at_parrot","**[Is It a Bird?]**");
        put("adventure/totem_of_undying","**[Postmortal]**");
        put("adventure/kill_a_mob","**[Monster Hunter]**");
        put("husbandry/plant_seed","**[A Seedy Place]**");
        put("nether/find_bastion","**[Those Were the Days]**");
        put("husbandry/axolotl_in_a_bucket","**[The Cutest Predator]**");
        put("adventure/spyglass_at_dragon","**[Is It a Plane?]**");
        put("husbandry/wax_on","**[Wax On]**");
        put("nether/obtain_ancient_debris","**[Hidden in the Depths]**");
        put("nether/create_full_beacon","**[Beaconator]**");
        put("nether/summon_wither","**[Withering Heights]**");
        put("nether/use_lodestone","**[Country Lode, Take Me Home]**");
        put("husbandry/safely_harvest_honey","**[Bee Our Guest]**");
        put("adventure/trade","**[What a Deal!]**");
        put("adventure/spyglass_at_ghast","**[Is It a Balloon?]**");
        put("story/mine_diamond","**[Diamonds!]**");
        put("husbandry/kill_axolotl_target","**[The Healing Power of Friendship!]**");
        put("nether/find_fortress","**[A Terrible Fortress]**");
        put("adventure/throw_trident","**[A Throwaway Joke]**");
        put("adventure/honey_block_slide","**[Sticky Situation]**");
